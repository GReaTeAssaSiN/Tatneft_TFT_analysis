...
para(
    doc,
    "\nОбратное преобразование прогноза выполняется через utils/data_utils.inverse_transform_predictions(): "
    "TorchNormalizer^-1 -> expm1(x) -> исходные единицы (литры/час для топлива, руб/ч для магазина).",
)
